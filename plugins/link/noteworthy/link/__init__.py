...
class LinkController(NoteworthyPlugin):
    ...
    @cli_method
    def connect(self, protocol: str, container_id: str=None, host_port: int=None, port: int=None, fqdn: str=None, link_id: str=None, hub_fqdn: str = 'hub.noteworthy.im'):
        ...
        Args:
            ...
            port: Port inside container to link
        ...
        print(lc.launch_launcher_taproot(fqdn, hub_fqdn, auth_code, fqdn.replace('.', '-'), network_mode=f'container:{container_id}', target_port=int(port)))
        print('Done.')
