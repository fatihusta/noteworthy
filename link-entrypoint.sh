...
wg set wg0 peer $TAPROOT_PUBKEY allowed-ips 10.0.0.2/32
...
iptables -t nat -A POSTROUTING -o wg0 -p tcp --dport 80 -j SNAT --to-source 10.0.0.1
iptables -t nat -A POSTROUTING -o wg0 -p tcp --dport 443 -j SNAT --to-source 10.0.0.1
